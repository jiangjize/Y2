...
<div class="container">
    ...
    <div class="row">
        <%--<form action="/addzixun" method="post" >--%>
            <form action="/zxupdate" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 pull-left">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="s_gnid" value="${iz.s_gnid}">
                                <input id="scid" name="s_cid" type="hidden" value="${iz.s_cid}">
                                <input type="text" disabled id="s_cid" name="scid" required class="form-control " value="${iz.s_cid}">
                                 <span class="input-group-btn">
                                     <button class="btn btn-default" data-toggle="modal" data-target="#myModal" type="button"><span class="glyphicon glyphicon-zoom-out " aria-hidden="true"></span></button>
                                 </span>
                                                                          ...
                                                                          <c:forEach items="${r.children}" var="chi">
                                                                              ...
                                                                              <ul class="tree_two">
                                                                                  <c:forEach items="${chi.children}" var="po3">
                                                                                      <a class="btn-default text-warning">${po3.s_cname}</a>
                                                                                  </c:forEach>
                                                                              </ul>
                                                                          </c:forEach>
                                                                      </li>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="s_gncrux" required
                                       class="form-control" value="${iz.s_gncrux}" placeholder="请输入关键词">
                            </div>
                        ...
                        <div class="col-md-4 ">
                            <div class="input-group">
                                ...
                                <input type="text" name="s_gntitle" required
                                       class="form-control" value="${iz.s_gntitle}" placeholder="请输入标题">
                                <%--创建者id--%>
                        ...
                        <div class="col-md-10">
                         <%--   <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <img src="upload/${iz.s_gnimage}" style="width: 200px; height: 200px">
                                <input type="hidden" name="s_gnimage" value="${iz.s_gnimage}">
...
<%--
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <textarea class="form-control" name="s_gnzhaiyao" >${iz.s_gnzhaiyao}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <section id="editor">
                                <div id='edit1' style="margin-top: 30px;">
                                    <div class="form-group">
                                        <textarea class="form"  id="edit" name="s_gnzhengwen" rows="3">
                                            ${iz.s_gnzhengwen}
                                        </textarea>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-md-offset-5">
                            <div class="btn-group">
                                <c:if test="${iz.s_gnstatus==1}">
                                    <input type="hidden" name="s_gnstatus" value="1">
                                <input type="submit" class="btn-info btn-lg" value="修改">
                                </c:if>
                                <c:if test="${iz.s_gnstatus==2}">
                                    <input type="hidden" name="s_gnstatus" value="2">
                                    <input type="submit" class="btn-warning btn-lg" value="发布">
                                </c:if>
                            </div>
                        </div>
                    </div>
