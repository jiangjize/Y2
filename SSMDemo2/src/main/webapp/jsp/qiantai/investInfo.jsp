							...
							<div id="navbar" class="collapse navbar-collapse">
					            <%--<ul class="nav navbar-nav font-family">
									...
									<c:forEach items="${ColumnList}" var="col">
										<ul class="nav navbar-nav font-family">
											<li <c:if test="${col.s_ccode=='tzzx'}">class="active"</c:if>><a href="#" onclick="tiaozhuan('${col.s_ccode}')">${col.s_cname}</a></li>
										</ul>
									</c:forEach>
					        </div>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="investInfo.jsp">投资咨询</a></span>
				</div>
			</div>
		</div>
						...
						<div class="content-state height-280">
							<div class="content-news-title">
								<div class="col-sm-6 col-md-6 padding-left">
									 <span id="invest-title" class="bold">
										<a href="investInfo-plann.jsp">企业战略咨询</a>
									</span>
								</div>
							</div>
									...
									<div class="col-sm-12 col-md-12">
										<div class="content-market-con-up">
											...
											<div class="col-sm-9 col-md-9 marketCon padding-right">
												...
												<p id="checkAll-market"><a href="investInfo-plann-more.jsp">[&nbsp;查看全文&nbsp;]</a></p>
											</div>
										</div>
										...
										<div class="content-state-con-down">
											<div class="col-sm-12 col-md-12 padding-left">
												<ul class="padding-top">
													<li><img src="images/index/dott_03.png"/><a href="newsDetails.jsp">青岛发布规划:5年内将建成全国领先智慧城市</a></li>
													<li><img src="images/index/dott_03.png"/><a href="newsDetails.jsp">青岛发布规划:5年内将建成全国领先智慧城市</a></li>
													<li><img src="images/index/dott_03.png"/><a href="newsDetails.jsp">2016-2021年中国镀膜系统用的激光自动消颗粒装置行业发展分析及投资潜力研究</a></li>
													<li><img src="images/index/dott_03.png"/><a href="newsDetails.jsp">2016-2021年中国镀膜系统用的激光自动消颗粒装置行业发展分析及投资潜力研究</a></li>
												</ul>
											</div>
										</div>
					...
					<div class="col-sm-12 col-md-6 padding-left padding-right">
						<div class="content-state height-280">
							<div class="content-news-title">
								<div class="col-sm-6 col-md-6 padding-left">
									<span id="invest-title" class="bold">
										<a href="investInfo-plann.jsp">园区规划</a>
									</span>
								</div>
							</div>
							<div class="content-state-con">
					...
					<div class="col-sm-12 col-md-6 padding-right">
						<div class="content-state height-280">
							<div class="content-news-title">
								<div class="col-sm-6 col-md-6 padding-left">
									<span id="invest-title" class="bold">
										<a href="investInfo-plann.jsp">可行性研究报告</a>
									</span>
								</div>
							</div>
							<div class="content-state-con">
					...
					<div class="col-sm-12 col-md-6 padding-left padding-right">
						<div class="content-state height-280">
							<div class="content-news-title">
								<div class="col-sm-6 col-md-6 padding-left">
									<span id="invest-title" class="bold">
										<a href="investInfo-plann.jsp">“新三板”咨询服务</a>
									</span>
								</div>
							</div>
							<div class="content-state-con">
					...
					<div class="col-sm-12 col-md-6 padding-right">
						<div class="content-state height-280">
							<div class="content-news-title">
								<div class="col-sm-6 col-md-6 padding-left">
									<span id="invest-title" class="bold">
										<a href="investInfo-plann.jsp">IPO咨询服务</a>
									</span>
								</div>
							</div>
							<div class="content-state-con">
