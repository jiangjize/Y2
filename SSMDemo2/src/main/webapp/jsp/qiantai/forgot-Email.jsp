				...
				<div class="col-md-10 col-md-offset-1 border1 margin-top-15 forgotNoticeDiv">
					...
					<div class="col-md-12 margin-top-20">
						<form action="#">
							<p><span>选择找回方式：</span>
								<select>
									<option>选择找回方式</option>
									<option>手机短信</option>
									<option>邮箱</option>
								</select>
							</p>
							<p class="emailtishi"><span></span>
								输入你注册的E-mail地址，请确保你的E-mail地址有效。</p>
							<p><span>我的注册邮箱：</span>
								<input type="text"/>
							</p>
							<p><span>邮箱验证码：</span>
							...
							<div class="col-md-10 text-center margin-top-30">
								<a class="btn btn-default goRegisterBth font-family" href="forgot-findEmail.jsp">确定</a>
							</div>
						</form>
					</div>
