...
<%@ page contentType="text/html;charset=UTF-8" language="java"  isELIgnored="false" %><html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="marketTrend.jsp">行情趋势</a>&nbsp;>&nbsp;<a href="wholeTrend.jsp">整体趋势</a></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left padding-right margin-top-25">
					<ul class="wholeList">
						<li class="border1">
							<div class="col-sm-2 col-md-2 padding-left padding-right">
								<img src="images/other/whole_03.png" id="wholeImg"/>
							</div>
							<div class="col-sm-10 col-md-10 padding-left padding-right font-family">
								<a href="newsDetails.jsp"><h4 class="font-family margin-top-30">2016-2021年中国自动控制设备产业市场行暨产业发展趋势研究报告。</h4></a>
								<span id="date-whole" class="margin-top-30">2016年8月5日</span>
								<a href="newsDetails.jsp"><p class="whole-content clearfix overflow-2">内容简介：第一章 木材装卸车相关概念 一、木材装卸车简介 二、木材装卸车的分类 三、木材装卸车的质量指标 第二节 木材装卸车的主要作用及用途简介 第三节 木材装卸车产品主要生产技术分析 一、木材装卸</p></a>
								<a href="newsDetails.jsp"><span id="checkDetail" class="text-right">【查看详情】</span></a>
							</div>
						</li>
						<li class="border1">
							<div class="col-sm-2 col-md-2 padding-left padding-right">
						...
						<li class="border1">
							...
							<div class="col-sm-10 col-md-10 padding-left padding-right font-family">
								<a href="newsDetails.jsp"><h4 class="font-family margin-top-30">2016-2021年中国自动控制设备产业市场行暨产业发展趋势研究报告。<img src="images/wholeTrend/zuanshi_06.png"/></h4></a>
								<span id="date-whole" class="margin-top-30">2016年8月5日</span>
								<a href="newsDetails.jsp"><p class="whole-content clearfix overflow-2">内容简介：第一章 木材装卸车相关概念 一、木材装卸车简介 二、木材装卸车的分类 三、木材装卸车的质量指标 第二节 木材装卸车的主要作用及用途简介 第三节 木材装卸车产品主要生产技术分析 一、木材装卸</p></a>
								<a href="newsDetails.jsp"><span id="checkDetail" class="text-right">【查看详情】</span></a>
							</div>
						...
						<li class="border1 border-bottom-1">
							<div class="col-sm-2 col-md-2 padding-left padding-right">
								<img src="images/other/whole_03.png" id="wholeImg"/>
							</div>
							<div class="col-sm-10 col-md-10 padding-left padding-right font-family">
