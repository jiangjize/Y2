...
<%@ page contentType="text/html;charset=UTF-8" language="java"  isELIgnored="false" %><html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="supplyInfo.jsp">供求信息</a>&nbsp;>&nbsp;<a href="supplyRelease.jsp">供应发布</a></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-right supplyRelaseConDiv margin-top-25">
					<form class="form-horizontal" id="supplyRelaseForm">
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">产品名称：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">所属分类：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">产地：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control chandi" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">等级：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">规格：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">品牌：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">供应数量：</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-4 control-label padding-right">上传照片：</label>
					    <div class="col-sm-4">
					      <img src="images/supply/photo_03.png" id="photo"/>
					      <span id="choosePhotoTxt">选择照片：<button class="btn btn-default font-family" onclick="document.getElementById('file1').click()">选择照片</button></span>
					      <input type="file" name="file1" id="file1" value=""/>
					    </div>
					  </div>
					  <div class="form-group">
					    <div class="col-sm-offset-4 col-sm-8">
					      <button type="submit" class="btn btn-default font-family margin-top-20">确认</button>
					    </div>
					  </div>
					</form>
				</div>
