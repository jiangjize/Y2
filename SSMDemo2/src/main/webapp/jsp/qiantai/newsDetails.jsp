	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="newsInfo.jsp">新闻资讯</a>&nbsp;>&nbsp;<a href="">新闻详情</a></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row border1 margin-top-25">
				...
				<div class="col-md-12">
					<p class="newsContent font-family">6月18日，江苏省大丰港国家级进口木材检疫处理区一期工程正式投入运营。区领导罗强、倪向荣出席投运仪式。</p>
					<img src="images/other/details_03.jpg" alt="新闻详情" id="newsDetailImg"/>
