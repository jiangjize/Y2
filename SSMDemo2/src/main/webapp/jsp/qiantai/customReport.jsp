...
<%@ page contentType="text/html;charset=UTF-8" language="java"  isELIgnored="false" %><html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/jsp/qiantai/css/customReport.css"/>
		<!--[if IE]>
							...
							<div id="navbar" class="collapse navbar-collapse">
					            <%--<ul class="nav navbar-nav font-family">
									...
									<c:forEach items="${ColumnList}" var="col">
										<ul class="nav navbar-nav font-family">
											<li <c:if test="${col.s_ccode=='dzbg'}">class="active"</c:if>><a href="#" onclick="tiaozhuan('${col.s_ccode}')">${col.s_cname}</a></li>
										</ul>
									</c:forEach>
					        </div>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="address">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="customReport.jsp">定制报告</a></span>
				</div>
			</div>
		</div>
	
		<!--定制报告-->
		<div class="container margin-top-30 border1">
			<div class="row">
				<div class="col-sm-12 col-md-12 padding-left padding-right">
					<div class="content-state">
						<div class="content-news-title">
							<div class="col-sm-6 col-md-6 col-md-offset-6 col-sm-offset-6">
								<a href="customReport-custom.jsp"><span id="custom">
									我要定制
								</span></a>
							</div>
						</div>
						...
						<div class="content-state-con">
							<div class="slideTxtBox">
								<div class="hd">
									<ul><li>年/季/月度报告</li><li>专项定制报告</li><li>竞争对手调研</li><li>市场调研</li></ul>
								</div>
								<div class="bd">
									<div class="row">
										<div class="col-sm-12 col-md-12">
											<div class="content">
												<h4><a href="customReport-details.jsp">2016-2021<span class="red">年度</span>非多孔木材可打磨的封闭底漆行业深度分析及“十三五”发展规划指导报告</a></h4>
												<p class="content-p">第一章 非多孔木材可打磨的封闭底漆行业相关概述 第一节 非多孔木材可打磨的封闭底漆行业定义及分类 一、行业定义 二、行业主要分类 三、行业特性及在国
													民经济中的地位 第二节 非多孔木材可打磨.........<span id="content-date">2016年8月5日</span>
												</p>
											</div>
											<div class="content">
												<h4><a href="customReport-details.jsp">2016-2021<span class="red">年度</span>非多孔木材可打磨的封闭底漆行业深度分析及“十三五”发展规划指导报告</a></h4>
	...
	<script src="${pageContext.request.contextPath}/jsp/qiantai/js/transformer.js" type="text/javascript" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/jsp/qiantai/js/jquery.SuperSlide.2.1.1.js" type="text/javascript" charset="utf-8"></script>
