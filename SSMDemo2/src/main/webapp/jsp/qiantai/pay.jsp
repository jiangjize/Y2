...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="businessSystem.jsp">商务系统</a>&nbsp;>&nbsp;<a href="payEntrance.jsp">支付</a></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 border1 margin-top-25 height-500">
					<div class="col-md-12 payTotalDiv margin-top-20">
						<p class="orderDetails"><span>订单编号：123456789456</span><span>商品名称：中国木材大数据平台</span></p>
						<h4 class="payMoney">支付金额：<span>￥4000.00</span></h4>
					</div>
					<div class="col-md-6 col-sm-6 payCode margin-top-55">
						<img src="images/customReport/code.jpg"/>
						<p class="text-center margin-top-15">微信支付</p>
					</div>
					<div class="col-md-6 col-sm-6 payCode margin-top-55">
						<img src="images/customReport/code.jpg"/>
						<p class="text-center margin-top-15">支付宝支付</p>
					</div>
				</div>
			</div>
		</div>
