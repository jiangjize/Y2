...
<%@ page contentType="text/html;charset=UTF-8" language="java"  isELIgnored="false" %><html>
	...
	<body>
							...
							<div id="navbar" class="collapse navbar-collapse">
					            <%--<ul class="nav navbar-nav font-family">
									...
									<c:forEach items="${ColumnList}" var="col">
										<ul class="nav navbar-nav font-family">
											<li <c:if test="${col.s_ccode=='swxt'}">class="active"</c:if>><a href="#" onclick="tiaozhuan('${col.s_ccode}')">${col.s_cname}</a></li>
										</ul>
									</c:forEach>
					        </div>
						</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 padding-left">
					<span id="addressSpan">您所在的位置是：<a href="index.jsp">首页</a>&nbsp;>&nbsp;<a href="businessSystem.jsp">商务系统</a></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 border1 margin-top-25 businessSystemConDiv">
					<h3 class="font-family">国数源仟佰商务与交易系统</h3>
					<a href="payEntrance.jsp"><img src="images/businessSystem/btn_07.png"/></a><!--付费入口-->
					<a href=""><img src="images/businessSystem/btn_05.png"/></a><!--用户登录-->
					<a href=""><img src="images/businessSystem/btn_03.png"/></a><!--用户体验-->
					<div class="col-md-12 margin-top-25 padding-left padding-right">
						<p class="font-family text-indent">
						...
						<img src="images/other/conImg_13.png" id="conImg"/>
						<p class="font-family text-indent">
						      据了解，大丰港国家级进口木材检疫处理区是国内首个示范性全封闭式木材熏蒸除害处理项目，项目创新应用了中国检验检疫科学研究院研究设计的熏蒸系统、浓度自动检测系统、气体回收装置等6项国家新型专利，实现了检疫处理高效、安全、环保的要求，检疫处理工艺技术达到国内领先、国际先进水平。 
						</p>
						<p class="font-family text-indent">
