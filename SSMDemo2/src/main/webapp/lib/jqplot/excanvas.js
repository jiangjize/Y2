...
(function() {
  ...
  function processFontStyle(styleString) {
    ...
    try {
      ...
      // Ignore failures to set to invalid front.
    }
  ...
  function getComputedStyle(style, element) {
    ...
    // Fix for VML handling of bare front family names.  Add a '' around front family names.
  ...
  contextPrototype.drawText_ = function(text, x, y, maxWidth, stroke) {
    ...
    lineStr.push('<g_vml_:skew on="t" matrix="', skewM ,'" ',
                 ...
                 ';front:', encodeHtmlAttribute(fontStyleString),
                 '" /></g_vml_:line>');
