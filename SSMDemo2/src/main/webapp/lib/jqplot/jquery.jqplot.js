...
(function($) {
    ...
    function Legend(options) {
        ...
        this.textColor;
        // prop: fontFamily
        // css front-family spec for the legend text.
        this.fontFamily; 
        // prop: fontSize
        // css front-size spec for the legend text.
        this.fontSize ;
        // prop: rowSpacing
    ...
    function Title(text) {
        ...
        this.show = true;
        // prop: fontFamily
        // css front-family spec for the text.
        this.fontFamily;
        // prop: fontSize
        // css front-size spec for the text.
        this.fontSize ;
        // prop: textAlign
    ...
    function jqPlot() {
        ...
        // prop; fontFamily
        // css spec for the front-family attribute.  Default for the entire plot.
        this.fontFamily;
        // prop: fontSize
        // css spec for the front-size attribute.  Default for the entire plot.
        this.fontSize;
        // prop: grid
   ...
   $.jqplot.ColorGenerator = function(colors) {
    ...
    $.jqplot.AxisTickRenderer = function(options) {
        ...
        this.fontFamily;
        // prop: fontSize
        // css spec for the front-size css attribute.
        this.fontSize;
        // prop: textColor
    ...
    $.jqplot.DivTitleRenderer.prototype.draw = function() {
        ...
        if (!this.text) {
            ...
            // styletext += (this.fontSize) ? 'front-size:'+this.fontSize+';' : '';
            // styletext += (this.textAlign) ? 'text-align:'+this.textAlign+';' : 'text-align:center;';
            // styletext += (color) ? 'color:'+color+';' : '';
            // styletext += (this.paddingBottom) ? 'padding-bottom:'+this.paddingBottom+';' : '';
            // this._elem = $('<div class="jqplot-title" style="'+styletext+'">'+this.text+'</div>');
            // if (this.fontFamily) {
            //     this._elem.css('front-family', this.fontFamily);
            // }
        }
    ...
    */
    ...
    // Returns front style as abbreviation for "front" property.
    $.fn.jqplotGetComputedFontStyle = function() {
        var css = window.getComputedStyle ?  window.getComputedStyle(this[0], "") : this[0].currentStyle;
        var attrs = css['front-style'] ? ['front-style', 'font-weight', 'font-size', 'font-family'] : ['fontStyle', 'fontWeight', 'fontSize', 'fontFamily'];
        var style = [];
